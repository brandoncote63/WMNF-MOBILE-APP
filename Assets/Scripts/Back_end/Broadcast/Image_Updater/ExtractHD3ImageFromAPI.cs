...
public class ExtractHD3ImageFromAPI : MonoBehaviour
{
    ...
    private IEnumerator LoadRssXml()
    {
        using (WWW www = new WWW(apiUrl))
        {
            ...
            if (string.IsNullOrEmpty(www.error))
            {
                ...
                // Parse the XML to extract the image URL for "WMNF HD3 The Source"
                broadcastChannelImageUrl = ExtractImageUrlFromXml(rssXml, "WMNF HD3 The Source");
